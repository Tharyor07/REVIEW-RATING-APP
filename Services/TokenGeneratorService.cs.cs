...
using repository_pattern.Helpers;
...
namespace repository_pattern.Services
{
    public class TokenGeneratorService : ITokenGenerator
    {
        ...
        public TokenGeneratorService(DataContext context, IOptions<JwtSettings> jwtsettings, UserManager<ApplicationUser> userManager)
        {
            _context = context;
